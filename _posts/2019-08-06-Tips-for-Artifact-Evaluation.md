...
\* Many AECs are formed via open invitation for applications -- typically you submit a short bio about yourself via a Google Form or similar [[Exhibit A](https://twitter.com/poplconf/status/1135895797520900097), [Exhibit B](https://twitter.com/vj_chidambaram/status/1151977134593908736)]. If you don't find one of these, look for conferences scheduled for about 3-6 months in the future that do not have an AEC finalized and email the AE chairs to find out how they will form the committee (chairs: sorry for the spam that I'm going to send your way). My guess is that they will be happy to talk to motivated grad students who are interested in such roles, especially if you have prior publications or AE experience.

---

If you have experience with artifact evaluation yourself and have more tips to add, some insights regarding other types of artifacts (e.g. survey data and user studies), or if you vehemently disagree with anything in this post, please let me know.
